...
Aggregated the data found in the Citi Bike Trip History Logs to build a data dashboard, story, or report.  Worked with a timespan of Jan - Nov 2018. Merge multiple datasets from different periods with Panadas and Jupyter Notebook.
...
The people reading analysis may not be data analysts. Visualizations should be colorful enough to be included in press releases, and analysis should be thoughtful enough for dictating programmatic changes. 
...
https://public.tableau.com/profile/christine.ton#!/vizhome/citi_bike_2018_analysis/Start_Stations
